...
<script type="text/javascript">
	Util.Objects["test"] = new function() {
		this.init = function(scene) {
			...
			u.deleteCookie("wtf_mem", {"path":"/"});

			// saveNodeCookie
			u.saveNodeCookie(scene, "test1", "s-value1");
			u.saveNodeCookie(scene, "test2", "s-value2");
			u.saveNodeCookie(footer, "test2", "f-value2");
			// u.bug(u.getCookie("wtf_mem"));
			if(u.getCookie("wtf_mem") == '{"DIV#content DIV.scene":{"test1":"s-value1","test2":"s-value2"},"DIV#footer":{"test2":"f-value2"}}') {
