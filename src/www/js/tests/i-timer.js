Util.Objects["timer"] = new function() {
	this.init = function(div) {
		...
		div.div_test_resetalltimers = u.ae(div, "div", {"class":"correct", "html":"u.t.resetAllTimers: correct"});
		...
		div.div_test_resetallintervals = u.ae(div, "div", {"class":"correct", "html":"u.t.resetAllIntervals: correct"});
		...
		div.div_test_timer = u.ae(div, "div", {"class":"error", "html":"u.t.setTimer (callback by reference): waiting"});
		...
		div.div_test_timer_name = u.ae(div, "div", {"class":"error", "html":"u.t.setTimer (callback to function name): waiting"});
		...
		div.div_test_reset_timer = u.ae(div, "div", {"class":"correct", "html":"u.t.resetTimer: correct"});
		...
		div.div_test_interval = u.ae(div, "div", {"class":"error", "html":"u.t.setInterval: waiting"});
		...
		div.test_valid = function() {
			u.ae(div, "div", {"class":"error", "html":"u.t.valid: error resetting"});
		...
		if(u.t.valid(div.t_valid_timer)) {
			...
			u.ae(div, "div", {"class":"correct", "html":"u.t.valid: correct"});
			div.test_results["u.t.valid - 1"] = true;
		}
		else {
			u.ae(div, "div", {"class":"error", "html":"u.t.valid: correct"});
			div.test_results["u.t.valid - 1"] = false;
		}
		...
		// test invalid timer
		if(!u.t.valid(div.t_valid_timer)) {
			u.ae(div, "div", {"class":"correct", "html":"u.t.valid (invalid timer): correct"});
			div.test_results["u.t.valid - 2"] = true;
		}
		else {
			u.ae(div, "div", {"class":"error", "html":"u.t.valid (invalid timer): error"});
