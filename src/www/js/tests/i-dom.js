Util.Objects["dom"] = new function() {
	this.init = function(div) {
		...
		if(u.ge("type:1").innerHTML == "getElement") {
			u.ge("type:1").innerHTML = "u.ge: correct";
			u.ge("type:1", div).parentNode.className = "correct";
			u.ac(u.ge("type:1", div), "correct");
		...
		// getElements
		if(u.ges("type\:[1-2]", div).length == 2) {
			u.ges("type\:[1-2]")[1].innerHTML = "u.ges: correct";
		...
		// appendElement
		node = u.ae(div, "div", {"class":"correct", "html":"u.ae: "});
		...
		// insertElement
		node = u.ie(div, "div", {"class":"error", "html":"u.ie: "});
		if(node == u.qs("div", div)) {
			u.ae(div, node, {"class":"correct"});
			node.innerHTML += "correct";
		...
		// wrap element
		node = u.ae(div, "div", {"class":"error", "html":"u.we error"});
		wrap_node = u.we(node, "div", {"class":"correct"});
		...
		u.ae(node, "div", {"class":"error", "html":"u.wc error"});
		wrap_node = u.wc(node, "div", {"class":"correct"});
		...
		if(text.trim() == "node.textContent") {
			u.ae(div, u.qs(".textcontent", div), {"class":"correct", "html":"u.text: correct"})
		...
		if(u.cv(u.qs("#qstest"), "type") == "cv") {
			u.ae(div, "div", {"class":"correct", "html":"u.cv: correct"});
			div.test_results["u.cv"] = true;
		}
		else {
			u.ae(div, "div", {"class":"error", "html":"u.cv: error"});
		...
		if(node.className == "test_headline") {
			u.ae(div, node, {"class":"correct", "html":"u.sc: correct"});
			div.test_results["u.sc"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"u.sc: error"});
		...
		if(
			...
			u.ae(div, node, {"class":"correct", "html":"u.hc: correct"});
			div.test_results["u.hc"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"u.hc: error"});
		...
		if(node.className == "test_headline headline:example headline") {
			u.ae(div, node, {"class":"correct", "html":"u.ac: correct"});
			div.test_results["u.ac"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"u.ac: error"});
		...
		if(node.className == "test_headline headline:example test:3") {
			u.ae(div, node, {"class":"correct", "html":"u.rc: correct"});
			div.test_results["u.rc"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"u.rc: error"});
		...
		if(node.className == old_class) {
			u.ae(div, node, {"class":"correct", "html":"u.tc: correct"});
			div.test_results["u.tc"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"u.tc: error"});
		...
		if(node.style.display == "none") {
			...
			u.ae(div, node, {"class":"correct", "html":"u.as: correct"});
			div.test_results["u.ass"] = true;
		}
		else {
			node.style.display = org_display;
			u.ae(div, node, {"class":"error", "html":"u.as: error"});
		...
		if(node.style.display == "inline" && node.style.width == "100px") {
			...
			u.ae(div, node, {"class":"correct", "html":"u.ass: correct"});
			div.test_results["u.ass"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"u.ass: error"});
		...
		if(u.gcs(gcs_node, "background-color") == "#ff0000" || u.gcs(gcs_node, "background-color") == "rgb(255, 0, 0)" && u.gcs(gcs_node, "height") == "1px") {
			...
			u.ae(div, "div", {"class":"correct", "html":"u.gcs: correct"});
			div.test_results["u.gcs"] = true;
		}
		else {
			gcs_node.parentNode.removeChild(gcs_node);
			u.ae(div, "div", {"class":"error", "html":"u.gcs: error"});
		...
		if(u.hfp(hfp_child) && !u.hfp(hfp_node)) {
			...
			u.ae(div, "div", {"class":"correct", "html":"u.hasFixedParent: correct"});
			div.test_results["u.hasFixedParent"] = true;
		}
		else {
			hfp_node.parentNode.removeChild(hfp_node);
			u.ae(div, "div", {"class":"error", "html":"hasFixedParent: error"});
		...
		if(u.nodeWithin(node, div) && !u.nodeWithin(div, node)) {
			u.ae(div, node, {"class":"correct", "html":"u.nodeWithin: correct"});
			div.test_results["u.nodeWithin"] = true;
		}
		else {
			u.ae(div, node, {"class":"error", "html":"nodeWithin: error"});
