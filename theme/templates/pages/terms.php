<div class="scene terms i:scene">
	...
	<div class="article" itemscope itemtype="http://schema.org/Article">
		...
		<div class="articlebody" itemprop="articleBody">
			<p>
				manipulator.parentnode.dk is owned and maintained by think.dk (in the 
			...
			<p>
				...
				<a rel="license" href="https://github.com/parentnode/manipulator_parentnode_dk/blob/master/LICENSE-CPAL.md">CPAL-1.0 licence</a>.
			</p>
			<p>
				The source code of Manipulator is licensed under a 
				<a rel="license" href="https://github.com/parentnode/manipulator/blob/master/MIT-LICENSE.txt">MIT-licence</a>.
			</p>
		</div>
	</div>
