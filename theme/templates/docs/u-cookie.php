		...
		<div class="body">
			...
			<div class="function" id="Util.saveCookie">
				...
				<div class="body">
					...
					<div class="description">
						<h4>Description</h4>
						<p>
							Save cookie. dependencies session cookies via sessionStorage as default. If <span class="var">expires</span> is not 
			...
			<div class="function" id="Util.saveNodeCookie">
				...
				<div class="body">
					...
					<div class="description">
						<h4>Description</h4>
						<p>Save cookie with node reference. dependencies session cookies. Node reference is an autogenerated string, based on ID, nodeName, name attribute or className.</p>
