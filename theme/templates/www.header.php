...
<head>
	...
	<meta name="keywords" content="JavaScript library object oo mvc js DOM framework parentnode html css animation manipulation" />
...
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment() ?>.css?rev=20190523-034415" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment() ?>.js?rev=20190523-034415"></script>
<? } ?>
