Util.Modules["mediaAutoplay"] = new function() {
...
// looping player
Util.Modules["medialoop"] = new function() {
	this.init = function(div) {
...
Util.Modules["mediacontrols"] = new function() {
	this.init = function(div) {
...
Util.Modules["mediamulticontrols"] = new function() {
	this.init = function(div) {
...
Util.Modules["mediafull"] = new function() {
	this.init = function(div) {
