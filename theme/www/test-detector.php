...
<head>
	...
	<title>Manipulator - Don't be scared - It's just JavaScript</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="keywords" content="JavaScript library object oo mvc js parentnode html css animation manipulation" />
	<meta name="description" content="Manipulator is an extensive modular cross-device JavaScript manipulation library" />
...
<div class="scene front i:front">
	...
	<div class="article" itemscope itemtype="http://schema.org/Article">
		<h1 itemprop="name">If manipulation is required ...</h1>

		<dl class="info">
			<dt class="published_at">Date published</dt>
			<dd class="published_at" itemprop="datePublished" content="2015-01-02">2015-01-02, 05:56</dd>
		...
		<div class="articlebody" itemprop="articleBody">
			<p>
				Manipulator 0.9 is now available for <a href="/download">download</a>.
			</p>
			<p>
	...
	<div id="navigation">
		<ul class="navigation">
			...
			<li class="gettingstarted"><a href="/getting-started">Getting started</a></li>
